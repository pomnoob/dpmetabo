...
write.csv(ts_pos,"data/ts all with MS2 names.csv",row.names = F)

write.csv(ts_posMS2,"data/ts all with MS2 only.csv",row.names = F)
...
write.csv(ac_vip_d,"data/ac plsda vip.csv")
```
...
ab_pls<-PlotPLSPairSummary(ab_pls, "figure/ab pls summary", "png", 72, width=NA, 5)

ab_pls<-PlotPLS2DScore(ab_pls, "figure/ab pls 2D score plot", "png", 72, width=NA, 1,2,0.95,0,0)

ab_pls<-PlotPLSLoading(ab_pls, "figure/ab pls loading", "png", 72, width=NA, 1, 2);

ab_pls<-PLSDA.CV(ab_pls, "T",5, "Q2")
ab_pls<-PlotPLS.Classification(ab_pls, "figure/ab pls cross validation", "png", 72, width=NA)

ab_pls_vip<-PlotPLS.Imp(ab_pls, "figure/ab pls_vip", "png", 72, width=NA, "vip", "Comp. 1", 15,FALSE)
...
write.csv(ab_vip_d,"data/ab plsda vip.csv")
```


```{r PLS analysis of BC using MetbcoAnalystR,include=FALSE}
library(MetbcoAnalystR)
...
bc_pls<-PlotPLSPairSummary(bc_pls, "figure/bc pls summary", "png", 72, width=NA, 5)

bc_pls<-PlotPLS2DScore(bc_pls, "figure/bc pls 2D score plot", "png", 72, width=NA, 1,2,0.95,0,0)

bc_pls<-PlotPLSLoading(bc_pls, "figure/bc pls loading", "png", 72, width=NA, 1, 2);

bc_pls<-PLSDA.CV(bc_pls, "T",5, "Q2")
bc_pls<-PlotPLS.Classification(bc_pls, "figure/bc pls cross validation", "png", 72, width=NA)

bc_pls_vip<-PlotPLS.Imp(bc_pls, "figure/bc pls_vip", "png", 72, width=NA, "vip", "Comp. 1", 15,FALSE)
...
write.csv(bc_vip_d,"data/bc plsda vip.csv")
```
