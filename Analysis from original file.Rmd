...
```{r metabolites table,echo=FALSE}
library(tidyverse)
vip.print <- dplyr::rename(pls.time.vip2,Metabolites=mid,T2=Hotelling.T2,VIP_ac=ac_vip_c1,VIP_ab=ab_vip_c1,VIP_bc=bc_vip_c1)

knitr::kable(
vip.print,caption = "T2 and VIP value of selected metabolites",digits=2,align="c"
)
```
